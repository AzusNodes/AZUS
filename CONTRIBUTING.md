Contributing to AZUS Core
============================

The AZUS Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/AzusNodes/AZUS/blob/master/doc/translation_process.md)
...
The following applies to code changes to the AZUS Core project, and is not to be
confused with overall AZUS Network Protocol consensus changes.

Whether a pull request is merged into AZUS Core rests with the project merge
...
Patches that change AZUS consensus rules are considerably more involved than
...
Where a patchset proposes to change the AZUS consensus, it must have been
...
The project leader is the release manager for each AZUS Core release.
