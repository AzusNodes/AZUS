...
Provides utilities for managing copyright headers of `The AZUS
...
---------------------------------------------------------
Updates all the copyright headers of `The AZUS developers` which were
...
------------------------------------
Inserts a copyright header for `The AZUS developers` at the top of the
...
If the file already has a copyright for `The AZUS developers`, the
script will exit.
...
Setup
---------
Configuring the github-merge tool for the AZUS repository is done in the following way:
...
A script to optimize png files in the AZUS
...
If there are 'unsupported' symbols, the return value will be 1 a list like this will be printed:
    ...
    .../64/test_azus: symbol memcpy from unsupported version GLIBC_2.14
    .../64/test_azus: symbol __fdelt_chk from unsupported version GLIBC_2.15
    .../64/test_azus: symbol std::out_of_range::~out_of_range() from unsupported version GLIBCXX_3.4.15
    .../64/test_azus: symbol _ZNSt8__detail15_List_nod from unsupported version GLIBCXX_3.4.15
