...
RESOURCES += src/qt/azus.qrc src/qt/azus_locale.qrc

TRANSLATIONS += src/qt/locale/azus_bg.ts \
                src/qt/locale/azus_de.ts \
                src/qt/locale/azus_en.ts \
                src/qt/locale/azus_es.ts \
                src/qt/locale/azus_fi.ts \
                src/qt/locale/azus_fr.ts \
                src/qt/locale/azus_it.ts \
                src/qt/locale/azus_ja.ts \
                src/qt/locale/azus_pl.ts \
                src/qt/locale/azus_pt.ts \
                src/qt/locale/azus_ru.ts \
                src/qt/locale/azus_sk.ts \
                src/qt/locale/azus_sv.ts \
                src/qt/locale/azus_vi.ts \
                src/qt/locale/azus_zh_CN.ts \
                src/qt/locale/azus_zh_TW.ts
