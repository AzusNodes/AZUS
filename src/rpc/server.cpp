...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* PIVX features */
        {"azus", "listmasternodes", &listmasternodes, true },
        {"azus", "getmasternodecount", &getmasternodecount, true },
        {"azus", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"azus", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"azus", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"azus", "masternodecurrent", &masternodecurrent, true },
        {"azus", "startmasternode", &startmasternode, true },
        {"azus", "createmasternodekey", &createmasternodekey, true },
        {"azus", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"azus", "listmasternodeconf", &listmasternodeconf, true },
        {"azus", "getmasternodestatus", &getmasternodestatus, true },
        {"azus", "getmasternodewinners", &getmasternodewinners, true },
        {"azus", "getmasternodescores", &getmasternodescores, true },
        {"azus", "preparebudget", &preparebudget, true },
        {"azus", "submitbudget", &submitbudget, true },
        {"azus", "mnbudgetvote", &mnbudgetvote, true },
        {"azus", "getbudgetvotes", &getbudgetvotes, true },
        {"azus", "getnextsuperblock", &getnextsuperblock, true },
        {"azus", "getbudgetprojection", &getbudgetprojection, true },
        {"azus", "getbudgetinfo", &getbudgetinfo, true },
        {"azus", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"azus", "mnfinalbudget", &mnfinalbudget, true },
        {"azus", "checkbudgets", &checkbudgets, true },
        {"azus", "mnsync", &mnsync, true },
        {"azus", "spork", &spork, true },
...
{
    return "> azus-cli " + methodname + " " + args + "\n";
}
