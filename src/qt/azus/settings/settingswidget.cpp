...
#include "qt/azus/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(AZUSGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &AZUSGUI::openFAQ);
