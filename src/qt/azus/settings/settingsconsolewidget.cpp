...
#include "qt/azus/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/azus/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(AZUSGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    message(CMD_REPLY, (tr("Welcome to the AZUS RPC console.") + "<br>" +
