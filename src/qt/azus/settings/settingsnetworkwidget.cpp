...
#include "qt/azus/settings/settingsnetworkwidget.h"
#include "qt/azus/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/azus/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(AZUSGUI* _window, QWidget *parent) :
