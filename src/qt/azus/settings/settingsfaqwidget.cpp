...
#include "qt/azus/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/azus/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(AZUSGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableAZU,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableAZU,
    ...
    connect(ui->pushButton_UnspendableAZU, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableAZU);});
    ...
    if (parent)
        connect(parent, &AZUSGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
