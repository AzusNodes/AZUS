...
#include "qt/azus/sendcustomfeedialog.h"
#include "qt/azus/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(AZUSGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &AZUSGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
