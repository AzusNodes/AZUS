...
#include "qt/azus/topbar.h"
#include "qt/azus/forms/ui_topbar.h"
#include "qt/azus/lockunlock.h"
#include "qt/azus/qtutils.h"
#include "qt/azus/receivedialog.h"
#include "qt/azus/loadingdialog.h"
...
TopBar::TopBar(AZUSGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopAzu}, "amount-small-topbar");
    setCssProperty({ui->labelAmountAzu}, "amount-topbar");
    setCssProperty({ui->labelPendingAzu, ui->labelImmatureAzu}, "amount-small-topbar");
...
void TopBar::updateBalances(const interfaces::WalletBalances& newBalance)
{
    ...
    // PIV Total
    QString totalAzu = GUIUtil::formatBalance(newBalance.balance, nDisplayUnit);

    // PIV
    // Top
    ui->labelAmountTopAzu->setText(totalAzu);
    // Expanded
    ui->labelAmountAzu->setText(totalAzu);
    ui->labelPendingAzu->setText(GUIUtil::formatBalance(newBalance.unconfirmed_balance, nDisplayUnit));
    ui->labelImmatureAzu->setText(GUIUtil::formatBalance(newBalance.immature_balance, nDisplayUnit));
}
