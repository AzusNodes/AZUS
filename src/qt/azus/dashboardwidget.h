...
#include "qt/azus/furabstractlistitemdelegate.h"
#include "qt/azus/furlistrow.h"
#include "transactiontablemodel.h"
#include "qt/azus/txviewholder.h"
...
#include "config/azus-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalAzu = 0;
    qint64 totalZazu = 0;
    QList<qreal> valuesAzu;
    QList<qreal> valueszAzu;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(AZUSGUI* _window);
    ~DashboardWidget();
