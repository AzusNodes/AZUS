...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, AZUSGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, AZUSGUI* gui, double posX = 3);
