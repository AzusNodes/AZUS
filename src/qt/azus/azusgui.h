...
#ifndef AZUS_CORE_NEW_GUI_AZUSGUI_H
#define AZUS_CORE_NEW_GUI_AZUSGUI_H
...
#include "qt/azus/navmenuwidget.h"
#include "qt/azus/topbar.h"
#include "qt/azus/dashboardwidget.h"
#include "qt/azus/send.h"
#include "qt/azus/receivewidget.h"
#include "qt/azus/addresseswidget.h"
#include "qt/azus/coldstakingwidget.h"
#include "qt/azus/masternodeswidget.h"
#include "qt/azus/snackbar.h"
#include "qt/azus/settings/settingswidget.h"
...
*/
class AZUSGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit AZUSGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~AZUSGUI();
