...
#include "qt/azus/forms/ui_masternodeswidget.h"

#include "qt/azus/qtutils.h"
#include "qt/azus/mnrow.h"
#include "qt/azus/mninfodialog.h"
#include "qt/azus/masternodewizarddialog.h"
...
MasterNodesWidget::MasterNodesWidget(AZUSGUI *parent) :
    PWidget(parent),
