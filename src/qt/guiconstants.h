...
/* Azus GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "AZUS"
#define QAPP_ORG_DOMAIN "azus.org"
#define QAPP_APP_NAME_DEFAULT "AZUS-Qt"
#define QAPP_APP_NAME_TESTNET "AZUS-Qt-testnet"
