...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            AZUSGUI* window = static_cast<AZUSGUI*>(parentWidget());
...
{
    AZUSGUI* gui = static_cast<AZUSGUI*>(parentWidget());
...
{
    hide();
    static_cast<AZUSGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("AZUS will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your AZUs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
