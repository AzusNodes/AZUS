...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(AZU);
    unitlist.append(mAZU);
    unitlist.append(uAZU);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    ...
    case AZU:
        return QString("azus");
    case mAZU:
        return QString("mazus");
    case uAZU:
        return QString::fromUtf8("uazus");
    default:
        return QString("???");
    }
}

QString BitcoinUnits::name(int unit, bool isZazu)
{
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZAZU)
{
    QSettings settings;
    ...
    return result + QString(" ") + name(unit, isZAZU);
}

QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZAZU)
{
    QString str(floorWithUnit(unit, amount, plussign, separators, cleanRemainderZeros, isZAZU));
    str.replace(QChar(THIN_SP_CP), QString(COMMA_HTML));
    return QString("<span style='white-space: nowrap;'>%1</span>").arg(str);
}
