...
#ifndef AZUS_ZAZUWALLET_H
#define AZUS_ZAZUWALLET_H
...
public:
    ...
    void GenerateDeterministicZAZU(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZAZU(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
