...
#ifndef AZUS_ZAZUTRACKER_H
#define AZUS_ZAZUTRACKER_H
...
public:
    CzAZUTracker(CWallet* parent);
    ~CzAZUTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzAZUWallet* zAZUWallet = NULL);
