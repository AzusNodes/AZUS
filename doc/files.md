...
azus.conf           | contains configuration settings for azusd or azus-qt
azusd.pid           | stores the process id of azusd while running
...
debug.log           | contains debug information and general logging generated by azusd or azus-qt
