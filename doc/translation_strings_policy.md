...
This document provides guidelines for internationalization of the AZUS Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `azus_en.ts` remains unchanged.
