...
The build script we'll be using is contained in the AZUS github repository ([contrib/gitian-build.py](https://github.com/AzusNodes/AZUS/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the AZUS repository and will need to fetch this script with the following commands:
...
- Clone the gitian-builder, gitian.sigs, azus-detached-sigs, and azus GitHub repos.
