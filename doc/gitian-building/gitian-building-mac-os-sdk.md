...
The script [extract-osx-sdk.sh](https://github.com/AzusNodes/AZUS/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
azus/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/AzusNodes/AZUS/blob/master/doc/README_osx.md) for troubleshooting tips.
